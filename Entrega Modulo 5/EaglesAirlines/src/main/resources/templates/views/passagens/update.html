...
<title>Eagles Airlines | Atualizar passagens</title>
</head>
<body>
		...
		<div class="container py-3">
			<form action="passagem-update">
				...
				<div class="form-group mb-3">
					<label for="id_passagem" class="form-label"> id_passagem </label> <input
				...
				<div class="form-group mb-3">
					<label for="quantidade" class="form-label"> Quantidade </label> <input
						type="number" id="quantidade" step="0.01" name="quantidade"
