...
<title>Eagles Airlines | Atualizar passageiro</title>
</head>
<body>
...
<header class="header">
	...
	<main class="newsletter">
		...
		<div class="container py-3">
			<form action="./passageiro-update">
				<h2 class="text-center">Atualizar</h2>
				 	            <div class="form-group mb-3">
				 	                <label for="CPF" class="form-label"> 
				 	                    CPF 
				 	                </label> 
				 	                <input type="text" id="CPF" name="CPF" class="form-control" value="${passageiro.CPF}" readonly/>
				 	            </div> 
				<div class="form-group mb-3">
					<label for="nome" class="form-label"> Nome </label> <input
						type="text" id="nome" name="nome" class="form-control"
						value="${passageiro.nome_passageiro}" />
				</div>

				<div class="form-group mb-3">
					<label for="passaporte" class="form-label"> passaporte </label> <input
						type="text" id="passaporte" name="passaporte" class="form-control"
