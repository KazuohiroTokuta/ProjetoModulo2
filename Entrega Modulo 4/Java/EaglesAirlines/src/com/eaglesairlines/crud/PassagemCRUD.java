package com.eaglesairlines.crud;
...
public class PassagemCRUD {
	...
	public static void main(String[] args) {
			...
			System.out.println("\n=========== BEM VINDO A PAGINA DE PASSAGENS DA EAGLES AIRLINES ==============\n");
			...
			System.out.println("Obrigado por utilizar a plataforma da Eagles Airlines");
			s.close();
