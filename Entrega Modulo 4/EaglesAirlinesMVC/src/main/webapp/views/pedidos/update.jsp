...
<title>Eagles Airlines | Atualizar pedidos</title>
</head>
<body>
		...
		<div class="container py-3">
			<form action="pedido-update">
				...
				<div class="form-group mb-3">
					<label for="num_pedido" class="form-label"> numero do pedido </label> <input
						type="text" id="num_pedido" name="num_pedido" class="form-control"
						value="${pedido.num_pedido}" readonly />
				</div>

				<div class="form-group mb-3">
					<label for="dt_pedido" class="form-label"> Data do pedido </label>
					<input type="text" id="dt_pedido" name="dt_pedido"
						class="form-control" value="${pedido.dt_pedido}" />
				</div>

				<div class="form-group mb-3">
					<label for="forma_pgmto" class="form-label"> Forma de
						pagamento </label> <input type="text" id="forma_pgmto" name="forma_pgmto"
						class="form-control" value="${pedido.forma_pgmto}" />
				</div>

				<div class="form-group mb-3">
					<label for="CPF" class="form-label"> CPF </label> <select id="CPF"
						name="CPF" class="form-control">
						<option value="DEFAULT">${pedido.passageiro.CPF}</option>
						<jstl:forEach items="${listaPassageiros}" var="p">
							<option value="${p.CPF}">${p.CPF}</option>
						</jstl:forEach>
					</select>
