...
<title>Eagles Airlines | Cadastrar pedidos</title>
</head>
<body>
	...
	<main class="newsletter">
		<div class="container py-3">
			<form action="pedido-create">
				<h2 class="text-center">Dados do pedido</h2>
				
				<div class="form-group mb-3">
					<label for="dt_pedido" class="form-label"> Data do pedido </label> <input
						type="text" id="dt_pedido" name="dt_pedido" class="form-control"
						value="" />
				</div>
				
				<div class="form-group mb-3">
					<label for="forma_pgmto" class="form-label"> Forma de pagamento </label> <input
						type="text" id="forma_pgmto" name="forma_pgmto" class="form-control"
						value="" />
				</div>
				...
				<a href="pedido" class="btn btn-danger"
